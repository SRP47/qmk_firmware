...
const uint16_t PROGMEM combo_f9[] = {KC_Z, KC_X, COMBO_END};
const uint16_t PROGMEM combo_f10[] = {KC_X, KC_C, COMBO_END};
const uint16_t PROGMEM combo_f11[] = {KC_C, KC_V, COMBO_END};
const uint16_t PROGMEM combo_f12[] = {KC_V, KC_B, COMBO_END};
